...
local library = {flags = {}, toggled = true, keybind = Enum.KeyCode.RightControl, dragSpeed = 0.1}
...
local themes = {
    ...
    Circus = { -- fuck
        TextColor = Color3.fromRGB(255, 255, 255),
        MainFrame = Color3.fromRGB(36, 36, 36),
        TabBackground = Color3.fromRGB(28, 28, 28),
        Tab = Color3.fromRGB(30, 30, 30),
        EnabledText = Color3.fromRGB(255, 255, 255),
        DisabledText = Color3.fromRGB(255, 255, 255),
        TabToggleEnabled = Color3.fromRGB(36, 36, 36),
        TabToggleDisabled = Color3.fromRGB(5, 5, 5),
        TabToggleDisabledMouseOver = Color3.fromRGB(20, 20, 20),
        Section = Color3.fromRGB(28, 28, 28),
        Button = Color3.fromRGB(36, 36, 36),
        ButtonMouseOver = Color3.fromRGB(40, 40, 40),
        ToggleEnabled = Color3.fromRGB(0, 255, 239), -- Accent
        ToggleEnabledMouseOver = Color3.fromRGB(0, 255, 239), -- Accent
        ToggleDisabled = Color3.fromRGB(36, 36, 36),
        ToggleDisabledMouseOver = Color3.fromRGB(40, 40, 40),
        Box = Color3.fromRGB(36, 36, 36),
        BoxFocused = Color3.fromRGB(40, 40, 40),
        Slider = Color3.fromRGB(36, 36, 36),
        SliderMouseOver = Color3.fromRGB(40, 40, 40),
        SliderFill = Color3.fromRGB(0, 255, 239),
        SliderFillSliding = Color3.fromRGB(0, 255, 239),
        Dropdown = Color3.fromRGB(36, 36, 36),
        DropdownMouseOver = Color3.fromRGB(40, 40, 40),
        DropdownContent = Color3.fromRGB(20, 20, 20),
        ColorPicker = Color3.fromRGB(20, 20, 20),
        ColorPickerBoxes = Color3.fromRGB(36, 36, 36)
    },
}

local themeObjects = {}
for i, v in next, themes.Deadly do -- here
    themeObjects[i] = {}
end
...
function library:CreateWindow(opts)
    ...
    local theme = themes[options.theme] or themes.Deadly -- here too
    ...
    function windowTypes:AddTab(name)
        ...
        function tabTypes:AddGroupBox(opts)
            local options = utility.format_table(opts)
            local name = options.name
            ...
            function sectionTypes:AddLabel(text)
            ...
            function sectionTypes:AddButton(opts)
                local options = utility.format_table(opts)
                local name = options.name
            ...
            function sectionTypes:AddToggle(opts)
                local options = utility.format_table(opts)
                local name = options.name
            ...
            function sectionTypes:AddInput(opts)
                local options = utility.format_table(opts)
            ...
            function sectionTypes:AddSlider(opts)
                local options = utility.format_table(opts)
                local name = options.name
            ...
            function sectionTypes:AddDropdown(opts)
                local options = utility.format_table(opts)
            ...
            function sectionTypes:AddKeybind(opts)
                local options = utility.format_table(opts)
                local name = options.name
            ...
            function sectionTypes:AddToggleKeybind(opts)
                local options = utility.format_table(opts)
                local name = options.name
                local default = options.default
            ...
            function sectionTypes:AddColorPicker(opts)
                local options = utility.format_table(opts)
                local name = options.name
                local default = options.default
                local flag = options.flag or nil
            ...
            function sectionTypes:AddToggleColorPicker(opts)
                local options = utility.format_table(opts)
                local name = options.name
                local default = options.default
